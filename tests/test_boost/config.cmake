...
SET(DIOS_CONFIG_MODULE test_boost) 
...
MACRO(dios_config_module_init MODULE)
	...
	# dios_module_link_library(${MODULE} boost_regex false)
	# dios_module_link_library(${MODULE} boost_serialization false)
	# dios_module_link_library(${MODULE} boost_python false)
	# dios_module_link_library(${MODULE} boost_wave false)
