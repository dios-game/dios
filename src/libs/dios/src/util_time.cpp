...
dios_uint64 dxm::util::CTime::NowTime(void)
{
	time_t time_sec; 
...
dios_uint64 dxm::util::CTime::ToTime(std::string date_time_string)
{
	struct tm tm; 
...
std::string dxm::util::CTime::ToTimeSpanString(dios_int64 time_span)
{
	char buff[128] = {0};
...
std::string dxm::util::CTime::ToDateTimeString(dios_uint64 time)
{
	time_t time_v = time;
	struct tm *tm; 
	tm = localtime(&time_v); 
...
std::string dxm::util::CTime::ToTimeString(dios_uint64 time)
{
	time_t time_v = time;
	struct tm *tm; 
	tm = localtime(&time_v); 
...
std::string dxm::util::CTime::ToDateString(dios_uint64 time)
{
	time_t time_v = time;
	struct tm *tm; 
	tm = localtime(&time_v); 
...
dios_int64 dxm::util::CTime::DiffTime(dios_uint64 time1, dios_uint64 time2)
{
	return time1 - time2;
}
