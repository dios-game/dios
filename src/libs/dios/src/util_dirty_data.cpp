...
void CDirtyData::Resize( dios_uint32 size )
{
	dirty_.Resize(size);
}

void CDirtyData::SetDirty( dios_uint32 index )
{
...
bool CDirtyData::GetDirty( dios_uint32 index )
{
