...
SET(DIOS_CONFIG_MODULE dios_db_table) 
...
MACRO(dios_config_module_init MODULE)
	...
	# dios_module_link_library(${MODULE} dios_util_boost false)
	...
	ENDIF()
	# dios_module_link_library(${MODULE} dios_dbtable false)
	# dios_module_link_library(${MODULE} dios_db_custom false)
	# dios_module_link_library(${MODULE} log_log4cplus false)
	# dios_module_link_library(${MODULE} network_libevent false)
