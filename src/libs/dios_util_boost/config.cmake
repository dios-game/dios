...
SET(DIOS_CONFIG_MODULE dios_util_boost) 
...
MACRO(dios_config_module_init MODULE)
	...
	ENDIF()
	dios_module_link_library(${MODULE} boost_atomic true)
	dios_module_link_library(${MODULE} boost_chrono true)
	dios_module_link_library(${MODULE} boost_thread true)
	dios_module_link_library(${MODULE} boost_system true)
	dios_module_link_library(${MODULE} boost_date_time true)
