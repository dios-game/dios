...
echo ##### 提示：编译 #####
BuildConsole.exe log4cplus.sln /prj=log4cplus /Silent /Cfg="Debug|x64,Release|x64" 
echo ##### 提示：拷贝 #####
...
echo #####提示：开始编译#####
rem BuildConsole.exe %project%.sln /prj=ALL_BUILD /Silent /OpenMonitor /Cfg="Debug|x64,Release|x64" 
