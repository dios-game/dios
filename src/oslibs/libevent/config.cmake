...
SET(DIOS_CONFIG_MODULE libevent) 
...
#	ENDFOREACH()
	...
	IF(DIOS_CMAKE_PLATFORM_WIN32)
		dios_find_module(${MODULE} PACKAGE libevent COMPONENTS libevent HEADERS libevent/event2/event.h)	
	ELSEIF(DIOS_CMAKE_PLATFORM_UNIX)	
		dios_find_module(${MODULE} PACKAGE libevent COMPONENTS event_core event_pthreads HEADERS libevent/event2/event.h)
