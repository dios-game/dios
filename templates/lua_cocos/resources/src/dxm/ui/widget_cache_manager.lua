...
function CWidgetCache:ctor(config)
    ...
    self.template_widget = self:LoadWidget()
    ...
    if widget ~= nil then
        ...
        self.template_widget = self:CloneWidget()
...
function CWidgetCache:CloneWidget()
    ...
    -- return self:_CloneWidget()
end

function CWidgetCache:_CloneWidget()

    local node = display.newNode()
    local widget = self.template_widget:getChildByTag(5)
    widget = widget:clone()
