		...
		foreach(USERFILE_CONFIGNAME ${CMAKE_CONFIGURATION_TYPES})
			if(LAUNCHER)
				if(LAUNCHER_DIRECTORY)
					set(USERFILE_${USERFILE_CONFIGNAME}_COMMAND ${LAUNCHER_DIRECTORY}/${USERFILE_CONFIGNAME}/${LAUNCHER})
				elseif()
					set(USERFILE_${USERFILE_CONFIGNAME}_COMMAND ${USERFILE_CONFIGNAME}/${LAUNCHER})
				endif()
			else()
...
macro(_launcher_create_target_launcher)
	if(CMAKE_CONFIGURATION_TYPES)
		...
		foreach(_config ${CMAKE_CONFIGURATION_TYPES})			
			if(LAUNCHER)
				if(LAUNCHER_DIRECTORY)
					set(USERFILE_COMMAND ${LAUNCHER_DIRECTORY}/${_config}/${LAUNCHER})
				else()
					set(USERFILE_COMMAND ${_config}/${LAUNCHER})
				endif()
			else()
				...
				file(TO_NATIVE_PATH "${USERFILE_${_config}_COMMAND}" USERFILE_COMMAND)
			endif()
		...
		if(LAUNCHER)
			if(LAUNCHER_DIRECTORY)
				set(USERFILE_COMMAND ${LAUNCHER_DIRECTORY}/${DIOS_CMAKE_COMPILER}/${LAUNCHER})
			else()
				set(USERFILE_COMMAND ${DIOS_CMAKE_COMPILER}/${LAUNCHER})
			endif()
		else()
