...
MACRO(_dios_configure_boost)	
	...
	set(BOOST_PREBUILT_DIRECTORY ${DIOS_MODULE_boost_DIRECTORY}/prebuilt/lib)
	...
	IF(DIOS_TARGET_WIN32 OR DIOS_TARGET_WIN64)
		...
		set(BOOST_LIBRARYDIR "${BOOST_PREBUILT_DIRECTORY}/lib/${DIOS_COMPILER}/boost")
	ELSEIF(DIOS_TARGET_UNIX)
		...
		set(Boost_USE_STATIC_RUNTIME     OFF)
		ADD_DEFINITIONS( -DBOOST_ALL_DYN_LINK )
		set(BOOST_LIBRARYDIR "${BOOST_PREBUILT_DIRECTORY}/lib/${DIOS_COMPILER}")
