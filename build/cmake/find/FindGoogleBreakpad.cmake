...
FOREACH(COMPONENT ${GoogleBreakpad_COMPONENTS})
	...
	IF(UNIX)
		...
		find_library( ${COMPONENT}_LIBRARY_RELEASE ${COMPONENT} 
			${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}
			)
	ELSE()

		# 在库根目录查找库
		find_library( ${COMPONENT}_LIBRARY_RELEASE ${COMPONENT}
				${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}/google_breakpad/release
				)
				
		find_library( ${COMPONENT}_LIBRARY_DEBUG ${COMPONENT}
				${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}/google_breakpad/debug
				)
	ENDIF()
