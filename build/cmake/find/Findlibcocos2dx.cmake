...
# 查询头文件
FIND_PATH(libcocos2dx_INCLUDE_DIR libcocos2dx/cocos2d.h ${DIOS_CMAKE_INSTALL_DIRECTORY}/inc)
...
FOREACH(COMPONENT ${libcocos2dx_COMPONENTS})
	...
	find_library( ${COMPONENT}_LIBRARY_RELEASE ${TEMP_COMPONENT}
				PATHS ${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}/libcocos2dx/release
				NO_DEFAULT_PATH
				)
				
	find_library( ${COMPONENT}_LIBRARY_DEBUG ${TEMP_COMPONENT}
				PATHS ${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}/libcocos2dx/debug
				NO_DEFAULT_PATH
				)
