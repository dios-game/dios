...
# 查询头文件
FIND_PATH(libcurl_INCLUDE_DIR libcurl/curl.h ${DIOS_CMAKE_INSTALL_DIRECTORY}/inc)
...
find_library( libcurl_LIBRARY_RELEASE libcurl_imp 
	PATHS ${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}/libcurl/release
	NO_DEFAULT_PATH
	)
		
find_library( libcurl_LIBRARY_DEBUG libcurl_imp 
	PATHS ${DIOS_CMAKE_INSTALL_DIRECTORY}/lib/${DIOS_CMAKE_COMPILER}/libcurl/debug
	NO_DEFAULT_PATH
	)
